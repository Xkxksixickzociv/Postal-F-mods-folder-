...
function onStepHit()
	if curStep == 1184 then
		...
		makeAnimatedLuaSprite('pico', 'GoinPostal/pico_heart_icons', 1130, 250)
		scaleObject('pico', .5, .5)
		setObjectCamera('pico', 'hud')
		addLuaSprite('pico', false)
		addAnimationByPrefix('pico', 'Thembeat', 'Heart  Pico instancia 1', 24, true)
		addAnimationByPrefix('pico', 'TheyLose', 'Heart  Pico loose  instancia 1', 24, true)
	end
end
...
function onBeatHit()
	...
	objectPlayAnimation('pico', 'Thembeat', 24, true)
end
