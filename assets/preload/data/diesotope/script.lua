...
-- Zoom in that one part the song where the inst chills for a quick sec
	if curStep == 224 then
		doTweenZoom('screenZoom', 'camGame', 0.7, 0.33, 'quintOut');
		end
...
-- Zoom back out
	if curStep == 227 then
		doTweenZoom('screenZoom', 'camGame', 0.8, 0.1, 'quadIn');
		end
...
-- boooh baaah bap at section 21
	if curStep == 336 then
		doTweenZoom('screenZoom', 'camGame', 0.7, 0.22, 'quadOut');
		end
...
-- boooh baaah boh with both at section 25
	...
	if curStep == 410 then
		doTweenZoom('screenZoom', 'camGame', 0.6, 0.1, 'quadIn');
		end
end
